...
class UperfProcessor(BaseProcessor):
    ...
    def _parse_config_csvs(self, result_dir: Path, test_type: str, protocol: str, packet_size: str) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            ...
            for instance_count in sorted(set(iops_data.keys()) | set(latency_data.keys()) | set(throughput_data.keys())):
                point = {
